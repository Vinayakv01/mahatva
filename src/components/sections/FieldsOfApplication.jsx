    ...
    >
      <div className="container mx-auto px-5 relative z-10">
        <div className="text-center mb-12" data-aos="zoom-in">
          <h2 
            className="text-accent text-[36px] font-semibold leading-tight mb-4"
          >
        ...
        <div className="relative max-w-full lg:max-w-[1100px] mx-auto">
          ...
          >
            {applications.map((app, index) => (
              <SwiperSlide key={index}>
                ...
                >
                  <a href="#" className="block text-center p-6 border border-white/20 bg-white/5 h-[190px] flex flex-col justify-center items-center group hover:scale-105 transition-transform duration-300">
                    <div className="mb-5">
                      <img src={app.icon} alt={app.name} className="w-[60px] h-[60px] object-contain" />
                    </div>
                    <h3 className="text-white text-xl font-medium">{app.name}</h3>
                  </a>
                </div>
              </SwiperSlide>
            ))}
          ...
          <button className="swiper-button-prev-custom-fields absolute top-1/2 -translate-y-1/2 -left-4 md:-left-12 text-white p-2 rounded-full border border-white/50 hover:bg-white/10 transition-colors z-20">
            <ChevronLeft size={32} />
          </button>
          <button className="swiper-button-next-custom-fields absolute top-1/2 -translate-y-1/2 -right-4 md:-right-12 text-white p-2 rounded-full border border-white/50 hover:bg-white/10 transition-colors z-20">
