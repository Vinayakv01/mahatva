...
const AboutMahatva = () => {
  return (
    <section className="relative w-full text-white">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="relative h-[500px] lg:h-[700px]">
          <div
            ...
            style={{
              backgroundImage: "url(https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/object/public/test-clones/d6064255-48bc-4eb5-b1fc-2e0647dd5996-tngseal-com/assets/images/og20241022141449144988420_jpg-27.webp)"
            }}
          />
        </div>
        ...
        <div className="hidden lg:grid grid-rows-2 h-[700px]">
          <div className="relative">
            <div
              className="absolute inset-0 bg-cover bg-center"
              style={{
                backgroundImage: "url(https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/object/public/test-clones/d6064255-48bc-4eb5-b1fc-2e0647dd5996-tngseal-com/assets/images/og20241022141631163178537_jpg-28.webp)"
              }}
            />
          </div>
          <div className="relative">
      ...
      <div className="absolute inset-0 flex items-center justify-center lg:justify-start bg-gray-900/50 lg:bg-transparent">
        <div className="lg:ml-16 w-11/12 max-w-lg lg:max-w-xl xl:max-w-2xl bg-[rgba(0,0,0,0.7)] backdrop-blur-[2px] p-6 sm:p-10 md:p-12">
          <h2 className="text-3xl lg:text-4xl font-semibold text-white mb-3">
            About Mahatva Engineering<sup>®</sup>
          </h2>
          ...
          <div className="space-y-4 text-white/90 text-sm lg:text-base leading-relaxed">
            <p>
          ...
          <Link
            to="/about"
            className="inline-flex items-center font-semibold text-white mt-8 transition-colors duration-300 hover:text-accent group"
          >
            Learn More
